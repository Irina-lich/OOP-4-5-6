...
public class FractalExplorer
{
    ...
    {
        enableUI(false); //вызов функции выкл. и вкл. вып. список
    ...
    //FractalWorker будет отвечать за вычисление значений цвета для
    //одной строки фрактала
    private class FractalWorker extends SwingWorker<Object, Object> //строчка из методички
    {
